...
//		oc.getAngle();
		...
		pageName = new String();
		pageName = getIntent().getStringExtra("POIname")+" detail information. Swipe down to hear more information about POIname.";
...
//						break;
					case 0:	
						...
						intent = new Intent(POImenu.this, Content2.class);
						intent.putExtra("content", content);
						startActivity(intent);
						break;
