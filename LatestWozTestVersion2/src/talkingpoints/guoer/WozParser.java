...
//    final MyAuthenticator auth = new MyAuthenticator();
//
//	//Install the custom authenticator
//	Authenticator.setDefault(auth);
	
	static final String username = "tpoints";
	static final String password = "tpointspsw";
	
	public class MyAuthenticator extends Authenticator{
		//This method is called when a password-protected URL is accesssed
