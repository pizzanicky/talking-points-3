...
public class POIsAhead2 extends GestureUI implements SensorEventListener {
...
//	public static ArrayList<String> MacAddrAhead;
	...
	private final double range = 45.0;
		...
		super.gestureScanner.setOnDoubleTapListener(new OnDoubleTapListener() {
			public boolean onDoubleTap(MotionEvent e) {
				...
				if(options.size()!=0){
					...
					Intent intent = new Intent(POIsAhead2.this, POImenu2.class);
