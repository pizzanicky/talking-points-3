...
public class Content2 extends GestureUI {
...
//		oc.getAngle();
		...
		pageName = new String();
		pageName = getIntent().getStringExtra("content");
...
//				{
					...
					case 0:
						...
						intent = new Intent(Content2.this, Content2.class);
...
//				}
				...
				if (p.getCommentId().size() >= 1
					...
					Intent intent = new Intent(Content2.this, Comments.class);
	...
	public boolean onKeyDown(int keyCode_1, KeyEvent event) {
		...
		if (keyCode_1 == KeyEvent.KEYCODE_DPAD_CENTER) {
			AngleCalculator oc = new AngleCalculator(byCoordinateParser.getLatitude(), byCoordinateParser
 			...
 			Intent intent0 = new Intent(Content2.this,POIsAhead.class);
// 			intent0.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			intent0.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

			Content2.this.startActivity(intent0);
//			POImenu.this.finish();
