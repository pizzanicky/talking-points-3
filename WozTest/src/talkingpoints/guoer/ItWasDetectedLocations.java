...
public class ItWasDetectedLocations extends GestureUI {
// 
//
...
// 								playSound(NEXT_PAGE);
// 								
//							   Intent intent = new Intent(ItWasDetectedLocations.this, POImenu.class);
...
// 		 
//			
//			Intent intent0 = new Intent(ItWasDetectedLocations.this,POIsAhead.class);
//// 			intent0.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//			intent0.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//
//			ItWasDetectedLocations.this.startActivity(intent0);
